...
import { defineEventHandler, handleCacheHeaders, splitCookiesString, isEvent, createEvent, fetchWithEvent, getRequestHeader, eventHandler, setHeaders, sendRedirect, proxyRequest, createError, setResponseHeader, send, getResponseStatus, setResponseStatus, setResponseHeaders, getRequestHeaders, createApp, createRouter as createRouter$1, toNodeListener, lazyEventHandler, getRouterParam, getQuery as getQuery$1, readBody, getResponseStatusText } from 'file://C:/Users/badys/OneDrive/Documents/VSCode/CMS/node_modules/h3/dist/index.mjs';
import fs from 'fs';
import path from 'path';
import { getRequestDependencies, getPreloadLinks, getPrefetchLinks, createRenderer } from 'file://C:/Users/badys/OneDrive/Documents/VSCode/CMS/node_modules/vue-bundle-renderer/dist/runtime.mjs';
import { stringify, uneval } from 'file://C:/Users/badys/OneDrive/Documents/VSCode/CMS/node_modules/devalue/index.js';
import destr from 'file://C:/Users/badys/OneDrive/Documents/VSCode/CMS/node_modules/destr/dist/index.mjs';
import { parseURL, withoutBase, joinURL, getQuery, withQuery, withTrailingSlash, joinRelativeURL } from 'file://C:/Users/badys/OneDrive/Documents/VSCode/CMS/node_modules/ufo/dist/index.mjs';
import { renderToString } from 'file://C:/Users/badys/OneDrive/Documents/VSCode/CMS/node_modules/vue/server-renderer/index.mjs';
import { hash } from 'file://C:/Users/badys/OneDrive/Documents/VSCode/CMS/node_modules/ohash/dist/index.mjs';
import { renderSSRHead } from 'file://C:/Users/badys/OneDrive/Documents/VSCode/CMS/node_modules/@unhead/ssr/dist/index.mjs';
import { createFetch as createFetch$1, Headers as Headers$1 } from 'file://C:/Users/badys/OneDrive/Documents/VSCode/CMS/node_modules/ofetch/dist/node.mjs';
import { createCall, createFetch } from 'file://C:/Users/badys/OneDrive/Documents/VSCode/CMS/node_modules/unenv/runtime/fetch/index.mjs';
import { createHooks } from 'file://C:/Users/badys/OneDrive/Documents/VSCode/CMS/node_modules/hookable/dist/index.mjs';
import { klona } from 'file://C:/Users/badys/OneDrive/Documents/VSCode/CMS/node_modules/klona/dist/index.mjs';
import { snakeCase } from 'file://C:/Users/badys/OneDrive/Documents/VSCode/CMS/node_modules/scule/dist/index.mjs';
import defu, { defuFn } from 'file://C:/Users/badys/OneDrive/Documents/VSCode/CMS/node_modules/defu/dist/defu.mjs';
import { createStorage, prefixStorage } from 'file://C:/Users/badys/OneDrive/Documents/VSCode/CMS/node_modules/unstorage/dist/index.mjs';
import unstorage_47drivers_47fs from 'file://C:/Users/badys/OneDrive/Documents/VSCode/CMS/node_modules/unstorage/drivers/fs.mjs';
import { toRouteMatcher, createRouter } from 'file://C:/Users/badys/OneDrive/Documents/VSCode/CMS/node_modules/radix3/dist/index.mjs';
import { AsyncLocalStorage } from 'node:async_hooks';
import { consola } from 'file://C:/Users/badys/OneDrive/Documents/VSCode/CMS/node_modules/consola/dist/index.mjs';
import { getContext } from 'file://C:/Users/badys/OneDrive/Documents/VSCode/CMS/node_modules/unctx/dist/index.mjs';
import { version, unref } from 'file://C:/Users/badys/OneDrive/Documents/VSCode/CMS/node_modules/vue/index.mjs';
import { createServerHead as createServerHead$1 } from 'file://C:/Users/badys/OneDrive/Documents/VSCode/CMS/node_modules/unhead/dist/index.mjs';
import { defineHeadPlugin } from 'file://C:/Users/badys/OneDrive/Documents/VSCode/CMS/node_modules/@unhead/shared/dist/index.mjs';
...
const serverAssets = [{"baseName":"server","dir":"C:/Users/badys/OneDrive/Documents/VSCode/CMS/server/assets"}];
...
storage.mount('root', unstorage_47drivers_47fs({"driver":"fs","readOnly":true,"base":"C:\\Users\\badys\\OneDrive\\Documents\\VSCode\\CMS","ignore":["**/node_modules/**","**/.git/**"]}));
storage.mount('src', unstorage_47drivers_47fs({"driver":"fs","readOnly":true,"base":"C:\\Users\\badys\\OneDrive\\Documents\\VSCode\\CMS\\server","ignore":["**/node_modules/**","**/.git/**"]}));
storage.mount('build', unstorage_47drivers_47fs({"driver":"fs","readOnly":false,"base":"C:\\Users\\badys\\OneDrive\\Documents\\VSCode\\CMS\\.nuxt","ignore":["**/node_modules/**","**/.git/**"]}));
storage.mount('cache', unstorage_47drivers_47fs({"driver":"fs","readOnly":false,"base":"C:\\Users\\badys\\OneDrive\\Documents\\VSCode\\CMS\\.nuxt\\cache","ignore":["**/node_modules/**","**/.git/**"]}));
storage.mount('data', unstorage_47drivers_47fs({"driver":"fs","base":"C:\\Users\\badys\\OneDrive\\Documents\\VSCode\\CMS\\.data\\kv","ignore":["**/node_modules/**","**/.git/**"]}));
...
const _jOHZGfLZ2A = (function(nitro) {
  nitro.hooks.hook("render:html", (htmlContext) => {
    htmlContext.head.push(`<script>${script}<\/script>`);
  });
});

const rootDir = "C:/Users/badys/OneDrive/Documents/VSCode/CMS";

const asyncContext = getContext("nuxt-dev", { asyncContext: true, AsyncLocalStorage });
const _Spz95ccwfr = (nitroApp) => {
...
const _lazy_WZgump = () => Promise.resolve().then(function () { return writeFile$1; });
const _lazy_8u40Kx = () => Promise.resolve().then(function () { return renderer$1; });

const handlers = [
  { route: '/api/writeFile', handler: _lazy_WZgump, lazy: true, middleware: false, method: undefined },
  { route: '/__nuxt_error', handler: _lazy_8u40Kx, lazy: true, middleware: false, method: undefined },
  { route: '/**', handler: _lazy_8u40Kx, lazy: true, middleware: false, method: undefined }
];
...
const writeFile = defineEventHandler(async (event) => {
  ...
  try {
    ...
    return { success: true, message: "Fichier modifi\xE9 avec succ\xE8s.", file: componentName };
  } catch (err) {
...
const writeFile$1 = /*#__PURE__*/Object.freeze({
  __proto__: null,
  default: writeFile
});
...
const getClientManifest = () => import('file://C:/Users/badys/OneDrive/Documents/VSCode/CMS/.nuxt/dist/server/client.manifest.mjs').then((r) => r.default || r).then((r) => typeof r === "function" ? r() : r);
const getServerEntry = () => import('file://C:/Users/badys/OneDrive/Documents/VSCode/CMS/.nuxt/dist/server/server.mjs').then((r) => r.default || r);
